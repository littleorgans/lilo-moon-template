...
| `docs/user-entity.md`, `packages/db/README.md`                                                                 | Skill `lilo-persistence`                                     | Record model, RLS rules, host portability.                                                                                                                                        |
| `docs/decisions.md`                                                                                            | Ref, condensed                                               | Rationale stays. Delete the template-lineage paragraphs. Skills link to it.                                                                                                       |
| `docs/how-to-instantiate.md` (retired; its surviving sections are in `docs/maintaining.md` and `docs/guides/`) | Rewrite → `docs/guides/adopt-web-app.md`, `adopt-service.md` | Toolchain setup, ports, env and publishing sections survive. Instantiation, rename and rebase sections are deleted.                                                               |
...
| Option                        | For                                                                                                | Against                                                                                                                                                                                                                                               |
| ----------------------------- | -------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| npm trusted publishing (OIDC) | No long-lived secret. Provenance is automatic. Publishing is bound to one repository and workflow. | A package must exist before a trusted publisher can be attached (npm/cli#8544, cited in `docs/how-to-instantiate.md`, since retired and now `docs/maintaining.md`). Needs npm CLI ≥ 11.5 [I]. pnpm/Changesets support under OIDC is unexercised here. |
