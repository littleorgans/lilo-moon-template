...
container that the gates and the integration tests share. Ownership labels guard container reuse
and cleanup; randomly suffixed databases isolate overlapping helper calls. Details are in `docs/maintaining.md`,
